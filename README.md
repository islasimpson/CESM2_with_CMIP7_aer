...
- yaml files that contain the information on the CMIP6 and CMIP7 source files and regridding needs (emission\_file\_anthro\_sfc\_info.yml, emission\_file\_anthro\_elev\_info.yml and emission\_file\_bmb\_sfc\_info.yml)
